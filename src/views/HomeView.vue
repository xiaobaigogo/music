<template>
  <div class="home-view">
    ...
    <div class="good-playlist">
      <h5>推荐歌单</h5>
      <cover v-for="(item, index) in goodPlaylist" :key="index" :dta="item" @click="playlistClick(item.id)"></cover>
    </div>
    <div class="new-songs">
      <h5>推荐歌曲</h5>
...
<script>
  ...
  import { getNewSongs, getGoodPlaylist, getCurrentSongURL } from "network/api.js";
  export default {
    name: "HomeView",
    data() {
      return {
